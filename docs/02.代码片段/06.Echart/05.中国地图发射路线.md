---
title: 中国地图发射路线
date: 2024-03-04 17:01:19
permalink: /pages/5a97fd/
---
### 示例效果
![微信截图_20240304190112](https://angelingRemon.github.io/picx-images-hosting/20240305/微信截图_20240304190112.3ye6uceu7h.webp)
...
import chinaChangeMap from "@/assets/json/chinaChange.json";
...
export default {
    ...
    mounted() {
        echarts.registerMap("china", chinaChangeMap);
    },
    methods: {
        //地图
        initCharts() {
        ...
        `
            ...
            let mapEcharts = echarts.init(document.getElementById("mapEcharts"));
...
### 相关文件
[中国地图发射路线：提取码(note)](https://pan.baidu.com/s/1OOpmyyV2OhlIW8a_TrjygA?pwd=note)
